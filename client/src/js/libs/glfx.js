var fx = function() {
    ...
    function z(a) {
        ...
        for (var c = 0; c < d; c++) this.ya.push(a[c][1]);
        this.u[0] = 0;
        this.y2[0] = 0;
        for (c = 1; c < d - 1; ++c) {
    ...
    (function() {
        ...
        function c(a) {
            if ("OES_texture_float_linear" === a) {
                if (void 0 === this.$OES_texture_float_linear$) {
                    Object.defineProperty(this, "$OES_texture_float_linear$", {
                        enumerable: false,
                        configurable: false,
                        writable: false,
                        value: new d() // Assuming `d` is a constructor function
                    });
                }
                a = this.$OES_texture_float_linear$;
            } else {
                a = n.call(this, a); // Assuming `n` is a function
            }
            return a;
        }
